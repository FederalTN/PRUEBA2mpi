...
int main(int argc, char* argv[])
{
    ...
    MPI_Group_intersection(groupA, groupB, &intersection_group);
    ...
    if(new_communicator == MPI_COMM_NULL)
    {
        ...
        printf("Process %d is not part of the intersection_group group.\n", my_rank);
    }
    else
    {
        // I am part of the communicator created, so I am part of the union group
        printf("Process %d is part of the intersection_group group.\n", my_rank);
    }
